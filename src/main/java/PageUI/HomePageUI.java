...
public class HomePageUI {
	public static final String SEARCH_TEXTBOX="//input[@type='text']";
	public static final String SEARCH_BUTTON="//button[@data-view-id='main_search_form_button']";
	public static final String TIKI_NOW_CHECKBOX="//label[@class='checkbox is-tikinow']/input";
	public static final String CONFIRM_BUTTON="//button[@class='apply-btn']";
